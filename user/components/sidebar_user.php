<?php $current = basename($_SERVER['PHP_SELF']); require_once __DIR__ . '/../../assets/logo.php'; ?>
<div class="gacoan-sidebar">
    <div class="brand">
        <div class="logo-box"><?= gacoanLogo(40) ?></div>
    ...
    <a href="<?= BASE_URL ?>user/index.php" class="nav-link <?= $current === 'index.php' ? 'active' : '' ?>">
        <i class="bi bi-speedometer2"></i> Dashboard
    </a>
    <a href="<?= BASE_URL ?>user/kendaraan.php" class="nav-link <?= $current === 'kendaraan.php' ? 'active' : '' ?>">
        <i class="bi bi-car-front"></i> Kendaraan Saya
    </a>
    <a href="<?= BASE_URL ?>user/booking.php" class="nav-link <?= $current === 'booking.php' ? 'active' : '' ?>">
        <i class="bi bi-calendar-check"></i> Booking Parkir
    </a>
    <a href="<?= BASE_URL ?>user/riwayat_parkir.php" class="nav-link <?= $current === 'riwayat_parkir.php' ? 'active' : '' ?>">
        <i class="bi bi-clock-history"></i> Riwayat Parkir
    </a>
    <a href="<?= BASE_URL ?>user/edit_profil.php" class="nav-link <?= $current === 'edit_profil.php' ? 'active' : '' ?>">
        ...
        <div class="dropdown">
            <div class="user-chip" role="button" data-bs-toggle="dropdown">
                ...
                <div>
                    ...
                    <div style="font-size:.7rem;color:#8d7f74;">User</div>
                </div>
                <i class="bi bi-chevron-down small"></i>
            </div>
            <ul class="dropdown-menu dropdown-menu-end mt-2">
                <li><a class="dropdown-item" href="<?= BASE_URL ?>user/edit_profil.php"><i class="bi bi-person-circle me-2"></i>Profil Saya</a></li>
