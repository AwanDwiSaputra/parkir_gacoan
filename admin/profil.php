        ...
        <div class="card card-m21">
            ...
            <div class="card-body text-center">
                ...
                <div class="mb-3">
                    ...
                    <?php else: ?>
                        <div style="width:140px;height:140px;border-radius:50%;background:linear-gradient(135deg,#b3121b,#ff6a00);
                ...
                <form method="POST" enctype="multipart/form-data" class="d-flex flex-column align-items-center gap-2">
                    ...
                    <button type="submit" class="btn btn-m21 w-100 mt-2">
        ...
        <div class="card card-m21">
            ...
            <div class="card-body">
                ...
                <p class="text-muted small mt-3 mb-0">
                    Untuk mengubah nama, username, atau password, silakan hubungi Administrator lain atau gunakan menu Kelola Pengguna.
                </p>
            </div>
        </div>
    </div>
