...
// header.php ada di member/template/, jadi naik dua folder ke img/logo-gacoan.png
...
<div class="gacoan-sidebar">
    ...
    <a href="<?= BASE_URL ?>member/index.php" class="nav-link <?= $current === 'index.php' ? 'active' : '' ?>">
        <i class="bi bi-speedometer2"></i> Dashboard
    </a>
    <a href="<?= BASE_URL ?>member/kendaraan.php" class="nav-link <?= $current === 'kendaraan.php' ? 'active' : '' ?>">
        <i class="bi bi-car-front"></i> Kendaraan Saya
    </a>
    <a href="<?= BASE_URL ?>member/booking.php" class="nav-link <?= $current === 'booking.php' ? 'active' : '' ?>">
        <i class="bi bi-calendar-check"></i> Booking Parkir
    </a>
    <a href="<?= BASE_URL ?>member/riwayat_parkir.php" class="nav-link <?= $current === 'riwayat_parkir.php' ? 'active' : '' ?>">
        <i class="bi bi-clock-history"></i> Riwayat Parkir
    </a>
    <a href="<?= BASE_URL ?>member/edit_profil.php" class="nav-link <?= $current === 'edit_profil.php' ? 'active' : '' ?>">
        ...
        <div class="dropdown">
            <div class="user-chip" role="button" data-bs-toggle="dropdown">
                ...
                <div>
                    ...
                    <div style="font-size:.7rem;color:#8d7f74;">Member</div>
                </div>
                <i class="bi bi-chevron-down small"></i>
            </div>
            <ul class="dropdown-menu dropdown-menu-end mt-2">
                <li><a class="dropdown-item" href="<?= BASE_URL ?>member/edit_profil.php"><i class="bi bi-person-circle me-2"></i>Profil Saya</a></li>
